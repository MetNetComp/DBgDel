...
ori_model = iMM904;
% Read the target CSV
Targetlist = readtable('possible_target_iMM904_no_e.csv', 'Delimiter', ',');
% Extract the first column as a cell array (useful for strings)
productionList = Targetlist{:, 1}; 
% Read the iMM904_RID file (gene-pseudoreaction-ID)
map_gene_list = readtable('iMM904_RID.csv', 'Delimiter', ',');
...
writetable(results_table, 'iMM904_results.csv');
...
writetable(results_table, 'iMM904_results_check.csv'); 