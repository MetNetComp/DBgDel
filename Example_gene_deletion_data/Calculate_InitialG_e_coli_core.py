...
def main(folder_path, output_file):
    ...
    print(f"The intersection of the remaining gene sets has been saved to {output_file}")

if __name__ == "__main__":
    # Get the path of the script
    script_dir = os.path.dirname(os.path.abspath(__file__))
    
    # Set default folder path to the script's directory
    folder_path = script_dir
    
    # Set default output file path within the script's directory
